            ...
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        @if (Auth::user()->image != "")
                            {{-- <img src="{{ asset('uploads/profile/'.Auth::user->image) }}" class="img-fluid rounded-circle" alt="Image">   
                        @else                         --}}
                            <img src="{{ asset('uploads/profile.jpg') }}" class="img-fluid rounded-circle" alt="Image" >                         
                        @endif
                    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('account.updateProfile') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @else                          
                                <img src="{{ asset('uploads/profile.jpg') }}" class="img-fluid mt-4" alt="Luna John" >
                            @endif --}}
                        </div>   
